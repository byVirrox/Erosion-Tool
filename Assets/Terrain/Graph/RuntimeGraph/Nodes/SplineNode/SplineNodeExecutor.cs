...
public class SplineNodeExecutor : ITerrainNodeExecutor
{
    ...
    /// <summary>
    /// Erstellt eine Kopie einer RenderTexture. Nützlich als Fallback.
    /// </summary>
    ...
    /// <summary>
    /// Erzeugt eine leere (schwarze) RenderTexture mit der gegebenen Auflösung.
    /// </summary>
    private RenderTexture CreateEmpty(int resolution)
    {
        ...
        // Eine neue temporäre RT ist standardmäßig bereits "leer" (schwarz/0),
        // daher sind keine weiteren Operationen nötig.
        return empty;
    }
}
