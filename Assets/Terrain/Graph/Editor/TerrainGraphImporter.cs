...
public class TerrainGraphImporter : ScriptedImporter
{
    ...
    /// <summary>
    /// Hilfsmethode für Phase 1: Sammelt alle erreichbaren Knoten in einer Liste.
    /// </summary>
    ...
    /// <summary>
    /// Kombinierte Methode: Durchläuft den Graphen, weist IDs zu und baut das Rezept in einem Durchlauf.
    /// </summary>
